/*
  ...
  - You are about to alter the column `timestampTry` on the `members` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `DateTime`.
